...
export class Player extends Component {
    ...
    render() {
            ...
            if(this.state.player.nombre!=="void"){  
                return(
                    <div className="players">
                        <img draggable="false" src={this.state.player.foto} alt={this.state.player.nombre}/>
        ...
        if(this.props.modalIsOpen){
            return(
                <div className="players">
                    <div draggable="false" className="modal-card" onClick={()=>{this.props.addPlayer(this.state.player.id); this.props.closeModal()}}>
